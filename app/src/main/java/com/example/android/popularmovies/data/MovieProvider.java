    ...
    static{
        ...
        sWeatherByLocationSettingQueryBuilder.setTables(
                MovieContract.MovieEntry.TABLE_NAME + " INNER JOIN " +
                        ...
                        " INNER JOIN ON " + MovieContract.MovieEntry.TABLE_NAME +
...
/*
    ...
    static UriMatcher buildUriMatcher() {
        ...
        //matcher.addURI(authority,MovieContract.PATH_MOVIE + '/*',MOVIE_WITH_TRAILER);
        //matcher.addURI(authority,MovieContract.PATH_MOVIE + '/*',MOVIE_WITH_REVIEW);
        //matcher.addURI(authority,MovieContract.PATH_MOVIE + '/*/*',MOVIE_WITH_TRAILER_AND_REVIEW);
